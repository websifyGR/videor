...
var newwidthpercent = getNameProperty+20;
	...
	document.getElementById('watchvid' + nextvideo).style.display = "block";
	  ...
	  /*
	  if (videoNumber==1){ player1.playVideo(); }
	  if (videoNumber==2){ player2.playVideo(); }
	  if (videoNumber==3){ player3.playVideo(); }
	  if (videoNumber==4){ player4.playVideo(); }
	  if (videoNumber==5){ player5.playVideo(); }
	  */
	  ...
	  /*
	  if (videoNumber==1){ player1.stopVideo(); }
      if (videoNumber==2){ player2.stopVideo(); }
      if (videoNumber==3){ player3.stopVideo(); }
      if (videoNumber==4){ player4.stopVideo(); }
      if (videoNumber==5){ player5.stopVideo(); }
	  */
	  switch(videoNumber){
	    case 1:
	      player1.stopVideo();
